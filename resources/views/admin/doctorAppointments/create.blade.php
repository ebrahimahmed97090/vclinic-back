...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.doctorAppointment.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.doctor-appointments.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('time_from') ? 'is-invalid' : '' }}" type="text" name="time_from" id="time_from" value="{{ old('time_from') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('time_to') ? 'is-invalid' : '' }}" type="text" name="time_to" id="time_to" value="{{ old('time_to') }}" required>
