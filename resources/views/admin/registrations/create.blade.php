    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.registrations.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('zoom_link') ? 'is-invalid' : '' }}" type="text" name="zoom_link" id="zoom_link" value="{{ old('zoom_link', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('zoom_data') ? 'is-invalid' : '' }}" type="text" name="zoom_data" id="zoom_data" value="{{ old('zoom_data', '') }}">
